const statusStyles: Record<string, { bg: string; text: string; glow?: string }> = {
  ...
  "entrada de leads": { bg: 'rgba(255,255,255,0.06)', text: 'text-muted-foreground' },
  contatado: { bg: 'rgba(59,130,246,0.12)', text: 'text-blue-400', glow: 'rgba(59,130,246,0.08)' },
  "tentando contato": { bg: 'rgba(59,130,246,0.12)', text: 'text-blue-400', glow: 'rgba(59,130,246,0.08)' },
  "reunião agendada": { bg: 'rgba(234,179,8,0.12)', text: 'text-yellow-400', glow: 'rgba(234,179,8,0.08)' },
  "demo agendada": { bg: 'rgba(234,179,8,0.12)', text: 'text-yellow-400', glow: 'rgba(234,179,8,0.08)' },
  "reunião realizada": { bg: 'rgba(249,115,22,0.12)', text: 'text-orange-400', glow: 'rgba(249,115,22,0.08)' },
  "porta aberta": { bg: 'rgba(249,115,22,0.12)', text: 'text-orange-400', glow: 'rgba(249,115,22,0.08)' },
